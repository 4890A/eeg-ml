...
d3.json(url2, function(BAarray) {
  ...
  pdata.html("");
  pdata.append("p").text(`Classified as: ${BAarray.real_output}`);
  ...
  pdata.append("p").text(`Number Correct predictions: ${nn} of ${totaln}`);
  ...
  pdata.append("p").text(`Number Correct predictions: ${dnn} of ${totaln}`);
  ...
  pdata.append("p").text(`Number Correct predictions: ${lr} of ${totaln}`);
...
function phoned(){
  ...
  d3.json(url2, function(phdata) {
    ...
    if (phdata.real_output[0] == "bike"){
      imagep = 'static/pic/bike1.jpg'
    } else if (phdata.real_output[0] == "walk") {
      imagep = 'static/pic/walk1.jpg'
    } else if (phdata.real_output[0] == "stand") {
      imagep = 'static/pic/stand1.png'
    } else if (phdata.real_output[0] == "stairsdown") {
      imagep = 'static/pic/downstair1.png'
    } else if (phdata.real_output[0] == "sit") {
      imagep = 'static/pic/sit1.png'
    } else {
      imagep = 'static/pic/stairsup.jpg'
    };
    ...
    pdata.html("");
    pdata.append("p").text(`Classified as: ${phdata.real_output}`);
    ...
    pdata.append("p").text(`Number Correct predictions: ${pnn} of ${totalp}`);
    ...
    pdata.append("p").text(`Number Correct predictions: ${lsp} of ${totalp}`);
...
function watchd(){
  ...
  d3.json(url2, function(phdata) {
    ...
    pdata.append("p").text(`Loss: ${phdata.NN.model_loss}`);
    pdata.append("p").text(`Prediction: ${phdata.NN.prediction}`);
    pdata.append("p").text(`Number Correct predictions: ${wnn} of ${totalw}`);
    ...
    pdata.append("p").text(`Loss: ${phdata.RNN.model_loss}`);
    pdata.append("p").text(`Prediction: ${phdata.RNN.prediction}`);
    pdata.append("p").text(`Number Correct predictions: ${lsw} of ${totalw}`);
